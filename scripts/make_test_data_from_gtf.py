...
'''
Example run:
python melanogaster/make_test_data_from_gtf.py \
  --fasta melanogaster/GCF_000001215.4_Release_6_plus_ISO1_MT_genomic.fna \
  --gtf melanogaster/GCF_000001215.4_Release_6_plus_ISO1_MT_genomic.gtf \
  --out_tsv melanogaster/test_data40.tsv \
  --donor_len 40 --donor_left 3 \
  --acceptor_len 40 --acceptor_right 3 \
'''
